...
productions = {
    ...
    # ["epsilon"] ?
    "stat_list_fix": [["stat_list"], [TokeTypes.tokClosedBracket]],
    ...
    "insert": [[TokeTypes.tokInsert, TokeTypes.tokOpenParen, "args_list", TokeTypes.tokClosedParen]],
    ...
    "leng_type": [[TokeTypes.tokBoard],  [TokeTypes.tokCPiece]],
    ...
    "params_list_fix": [["epsilon"], [TokeTypes.tokComma, "params_list"]],
    ...
    "func_call": [ ["dic_func"], [TokeTypes.tokID, TokeTypes.tokOpenParen, "args_list", TokeTypes.tokClosedParen]],
